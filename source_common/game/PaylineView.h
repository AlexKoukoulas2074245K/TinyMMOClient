...
public:
    ...
    void AnimatePaylineReveal(const int winningSymbolCount, const float revealAnimationDurationSecs, const float hidingAnimationDurationSecs, const float delaySecs = 0.0f);
