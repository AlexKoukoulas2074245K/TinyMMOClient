...
files = Dir.glob(["../source_common/**/*.cpp", "../source_common/**/*.h","../source_net_common/**/*.cpp", "../source_net_common/**/*.h","../source_ios/**/*.cpp", "../source_ios/**/*.h", "../source_ios/**/*.m", "../source_ios/**/*.mm", "../source_apple_utilities/**/*.cpp", "../source_apple_utilities/**/*.h", "../source_apple_utilities/**/*.m", "../source_apple_utilities/**/*.mm"]).select{|file| !file.include? "imgui" and !file.include? "main.cpp"}
