...
#else
static constexpr int DEFAULT_WINDOW_WIDTH  = 390;
static constexpr int DEFAULT_WINDOW_HEIGHT = 844;
static constexpr int MIN_WINDOW_WIDTH      = 260;
static constexpr int MIN_WINDOW_HEIGHT     = 562;
#endif
